! function (o, l) {
    ...
    function P(e, r) {
        var t, n, i, o, a = C + O++,
            ...
            d = !1;
        if (u[b]) {
            for (i = 0; i < u[b]; i++) n = u[i].localName, n in N && (l[n] = 1);
        ...
        if (r) {
            ...
            if (i) {
                n.copyAttributes && function c(e, r) {
                    ...
                    ["xlink:href", "href"].forEach(function (e) {
                        var r = r[w](e);
                        /^\s*#/.test(r) && (r = r.trim(), r && (r = r + a), r && r !== w(e) && (r = r + a, r = r.substring(1), r && (r = r.substring(1)), r && (r = r.substring(1)), r && (r = r.substring(1))))
                    })
                }(e, r);
